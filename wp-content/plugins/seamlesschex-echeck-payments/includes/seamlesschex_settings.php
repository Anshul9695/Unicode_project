...
//       ********************************************************************************************** 
	...
	add_settings_field(
		...
		__( 'Recurring', 'woocommerce-gateway-seamlesschex' ),
...
function seamlesschex_gateway_recurring_render() {
    $options = get_option('seamlesschex_settings');
        ?>
    		<select name='seamlesschex_settings[seamlesschex_gateway_recurring]'>
    			<option value='0' <?php selected( $options['seamlesschex_gateway_recurring'], 0); ?>>Disabled</option>
    			<option value='1' <?php selected( $options['seamlesschex_gateway_recurring'], 1); ?>>Enabled</option>
    		</select>
...
function seamlesschex_title_render(  ) {
	$options = get_option( 'seamlesschex_settings' );
	$value = isset($options['seamlesschex_title']) ? $options['seamlesschex_title'] : "";
...
function seamlesschex_settings_validate($settings){
	...
	if(!$gateway->register_store($settings["seamlesschex_site_url"])) {
